...
class dataProcess(object):
    ...
    def __init__(self, out_rows, out_cols, data_path="data/measurement/400", label_path="data/measurement/400",
                 test_path="data/measurement/400", npy_path="npydata/crop_con", img_type="tif"):
